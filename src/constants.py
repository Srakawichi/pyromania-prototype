...
MATS = {
    "dry_grass":  dict(color=(230,230,73), min_temp=14, energy=1,  heat=0.9,  burn_time=4.0,  spread=0.18, points=5,   exp_r=0, label="Gras"),
    "oil":        dict(color=(122,91,6),   min_temp=280, energy=2,  heat=1.8,  burn_time=6.0,  spread=0.75, points=50,  exp_r=4, label="Oel"),
    ...
    "gas_station":dict(color=(255,0,255),  min_temp=350, energy=25, heat=9.0, burn_time=6.0,  spread=1.0,  points=500, exp_r=8, label="Gasp."),
